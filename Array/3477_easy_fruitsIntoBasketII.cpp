...
//     basket can hold only one type of fruit. If a fruit type cannot be placed
//     in any basket, it remains unplaced.
//
...
//     but can be placed in the next available basket, baskets[2] = 7. fruits[2]
//     = 1 is placed in baskets[1] = 4.
//
