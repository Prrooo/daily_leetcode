...
//     array. You are allowed to pass through points that appear later in the
...
// [1,2] -> [0,1] -> [-1,0] Time from [1,1] to [3,4] = 3 seconds Time from [3,4]
// to [-1,0] = 4 seconds Total time = 7 seconds
//
// Example 2:
//
