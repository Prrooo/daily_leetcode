...
// return 2 recentCounter.ping(3001);  // requests = [1, 100, 3001], range is
// [1,3001], return 3 recentCounter.ping(3002);  // requests = [1, 100, 3001,
// 3002], range is [2,3002], return 3
//
...
public:
  ...
  int ping(int t) {
    ...
    while (!qu.empty() && (t - 3000) > qu.front()) {
      qu.pop();
    }
    qu.push(t);
    return qu.size();
