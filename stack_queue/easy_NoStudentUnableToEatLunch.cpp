...
//     of the stack, they will take it and leave the queue. Otherwise, they will
//     leave it and go to the queue's end.
//
...
// is the type of the i​​​​​​th sandwich in the stack (i = 0 is the
...
public:
  int countStudents(vector<int> &students, vector<int> &sandwiches) {
    ...
    for (int i = 0; i < n; i++) {
      int j = 0, m = qu.size();
      while (j < m && qu.front() != sandwiches[i]) {
        qu.push(qu.front());
        qu.pop();
        j++;
      }
